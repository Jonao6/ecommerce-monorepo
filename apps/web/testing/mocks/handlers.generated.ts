 ...
 * )
 */
export const mockCreateUserMutation = (
 ...
 * )
 */
export const mockGetUserMutation = (
	resolver: GraphQLResponseResolver<GetUserMutation, GetUserMutationVariables>,
	options?: RequestHandlerOptions,
) =>
...
export const mockMeQuery = (
	resolver: GraphQLResponseResolver<MeQuery, MeQueryVariables>,
	options?: RequestHandlerOptions,
) => graphql.query<MeQuery, MeQueryVariables>('Me', resolver, options);
 ...
 * )
 */
export const mockCreateAddressMutation = (
	resolver: GraphQLResponseResolver<
 ...
 * )
 */
export const mockCreatePaymentIntentMutation = (
	resolver: GraphQLResponseResolver<
	...
	graphql.mutation<
		CreatePaymentIntentMutation,
		CreatePaymentIntentMutationVariables
	>('CreatePaymentIntent', resolver, options);
 ...
 * )
 */
export const mockCreateOrderMutation = (
	resolver: GraphQLResponseResolver<
		CreateOrderMutation,
...
export const mockOrderQuery = (
	resolver: GraphQLResponseResolver<OrderQuery, OrderQueryVariables>,
	options?: RequestHandlerOptions,
) => graphql.query<OrderQuery, OrderQueryVariables>('Order', resolver, options);
 ...
 * )
 */
export const mockDeleteAddressMutation = (
	resolver: GraphQLResponseResolver<
 ...
 * )
 */
export const mockUserAddressesQuery = (
	resolver: GraphQLResponseResolver<
		UserAddressesQuery,
 ...
 * )
 */
export const mockUserOrdersQuery = (
	resolver: GraphQLResponseResolver<UserOrdersQuery, UserOrdersQueryVariables>,
	options?: RequestHandlerOptions,
) =>
 ...
 * )
 */
export const mockCategoriesQuery = (
	resolver: GraphQLResponseResolver<CategoriesQuery, CategoriesQueryVariables>,
	options?: RequestHandlerOptions,
) =>
 ...
 * )
 */
export const mockCategoryQuery = (
	resolver: GraphQLResponseResolver<CategoryQuery, CategoryQueryVariables>,
	options?: RequestHandlerOptions,
) =>
 ...
 * )
 */
export const mockHomeProductsQuery = (
	resolver: GraphQLResponseResolver<
		HomeProductsQuery,
 ...
 * )
 */
export const mockProductsQuery = (
	resolver: GraphQLResponseResolver<ProductsQuery, ProductsQueryVariables>,
	options?: RequestHandlerOptions,
) =>
 ...
 * )
 */
export const mockProductsBySearchQuery = (
	resolver: GraphQLResponseResolver<
